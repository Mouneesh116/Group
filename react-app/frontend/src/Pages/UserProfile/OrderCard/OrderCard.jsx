...
//             try {
//                 const response = await axios.get(
//                     http://localhost:8080/api/orders/status/${order._id}`,
//                     {
//                         headers: {
//                             'Content-Type': 'application/json',
//                             Authorization: `Bearer ${token}`,
...
//         http://localhost:8080/api/orders/cancel-item/${order.id}`, // Use order._id here
...
const OrderCard = ({ order, productId, price, title, onOrderCancel, quantity }) => {
    ...
    const handleReviewSubmit = async () => {
        try {
            const response = await axios.post(
                `http://localhost:8080/api/users/reviews/add/${productId}`, // Endpoint for adding reviews
        ...
        <div className="order-card-container">
            <div className="order-card-main-content">
                ...
                <div className="order-card-info">
                    ...
                    <p className="order-card-detail">
                        <strong>Total Price:</strong> ₹{price * quantity}
                    </p>
                </div>
            </div>
