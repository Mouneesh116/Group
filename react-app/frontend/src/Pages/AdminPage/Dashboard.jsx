  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        const salesResponse = await axios.get(`http://localhost:8080/api/admin/sales`,{
          headers: {
            Authorization: `Bearer ${token}`,
          }
        });
        const ordersResponse = await axios.get(`http://localhost:8080/api/admin/orders`,{
          headers: {
            Authorization: `Bearer ${token}`,
          }
        });
        const categoryResponse = await axios.get(`http://localhost:8080/api/admin/category-sales`,{
          headers: {
            Authorization: `Bearer ${token}`,
          }
        });
