...
export const WishListProvider = ({ children }) => {
    ...
    const API_BASE_URL = process.env.REACT_APP_API_BACKEND_URL || 'http://localhost:5000'; // Ensure this is set correctly 
    ...
    useEffect(() => {
        const fetchUserWishlist = async () => {
            ...
            try {
                const response = await axios.get(`${API_BASE_URL}/api/users/wishlist/getItems`, {
                    headers: {
